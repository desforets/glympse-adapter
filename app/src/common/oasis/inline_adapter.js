...
define(function (require, exports, module) {
	...
	var __dependency1__ = require("oasis/util"),
		__dependency2__ = require("oasis/config"),
		__dependency3__ = require("oasis/shims"),
		__dependency4__ = require("oasis/xhr"),
		RSVP = require("rsvp"),
	...
	var InlineAdapter = extend(BaseAdapter, {
		...
		connectPorts: function (sandbox, ports) {
			var rawPorts = a_map.call(ports, function (oasisPort) {
					return oasisPort.port;
				}),
